...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Cancelled Orders | </span><span style="font-size:24px; font-family:Museo;"><?php echo date('j F, Y ');?></span><br><br>
<div id="demo"></div>
...
$gtx_query.=" WHERE now='{$now}' and whether_taken='CANCELLED'";
$gtx_result=mysql_query($gtx_query,$gtx_connection);

if(mysql_num_rows($gtx_result)==0 )
{ 
echo "No order yet got cancelled.";
