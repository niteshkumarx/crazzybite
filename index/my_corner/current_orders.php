...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Current Orders | </span><span style="font-size:24px; font-family:Museo;"><?php echo date('j F, Y ');?></span><br><br>
<div id="demo"></div>
