...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Customer Database (Alphabetical) </span><br><br>
<div id="demo"></div>
...
$gtx_query="SELECT * from user_database where block<>'TRUE' ORDER BY fb_name ASC";
