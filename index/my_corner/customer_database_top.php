...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Top Customers</span><br><br>
<div id="demo"></div>
...
$gtx_query="SELECT * from user_database where block<>'TRUE' ORDER BY buying_frequency DESC LIMIT 20";
...
$(document).ready(function(){
    ...
    $(\"#{$trim5}\").click(function(){
        $(\"#{$trim6}\").show();
			...
			<br/><span style=\"font-size:24px; font-family:Museo \">Total Orders(Till Date):</span> <span style=\"font-size:40px; font-family:Museo; color:#71D4FF; \">{$row['buying_frequency']}</span>
		 </span>";
