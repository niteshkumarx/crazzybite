...
{
header("Location:../");}
//setting date fro past orders
$date = str_replace('-', '', $_GET['select_date_here']);
$select_date= date('Ymd', strtotime($date));
//security divert
?>
<!DOCTYPE html>
<html>
...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Past Orders | </span><span style="font-size:24px; font-family:Museo;"><?php echo date('j F, Y ',strtotime($date));?></span><br><br>
<div id="demo"></div>
