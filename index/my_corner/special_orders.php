...
<body>
			...
			<a class="linky" title="You can view all the special orders for past month." style="color:#fff;"href="index.php?all_special_orders=1">View All<a></span>
				 <br><br>
<div id="demo"></div>
...
$gtx_query.=" WHERE status<>'YES' AND date> DATE_SUB(NOW(), INTERVAL 1 MONTH)";
$gtx_result=mysql_query($gtx_query,$gtx_connection);

if(mysql_num_rows($gtx_result)==0 )
{ 
echo "There are no unattended special orders for past one month.";
