...
<body>
           	...
           	<span style="font-size:40px; color:#058AA8; font-family:Museo;"> Verified Customers </span><br><br>
<div id="demo"></div>
...
$gtx_query="SELECT * from user_database where verified_user='VERIFIED'";
...
{ 
echo "<br> You dont have any verified customer in the database.";
